...
function TermsContent() {
  return (
    <>
      ...
      <section>
        <h3 className="font-semibold text-base mb-2">제7조 운영자의 의무</h3>
        <p className="mb-1">① 운영자는 이용회원으로부터 제기되는 의견이나 불만이 정당하다고 인정할 경우에는 가급적 빨리 처리하여야 합니다. 다만, 개인적인 사정으로 신속한 처리가 곤란한 경우에는 사후에 공지 또는 이용회원에게 쪽지, 전자우편 등을 보내는 등 최선을 다합니다.</p>
        <p>② 운영자는 지속적이고 안정적인 사이트 제공을 위하여 설비에 장애가 생기거나 유실된 때에는 이를 지체 없이 수리 또는 복구할 수 있도록 사이트에 요구할 수 있습니다. 다만, 천재지변 또는 사이트나 운영자에 부득이한 사유가 있는 경우, 사이트 운영을 일시 정지할 수 있습니다.</p>
      </section>

      <section>
        <h3 className="font-semibold text-base mb-2">제8조 회원의 의무</h3>
      ...
      <section>
        <h3 className="font-semibold text-base mb-2">제9조 서비스 이용 시간</h3>
        <p className="mb-1">① 서비스 이용 시간은 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴 1일 24시간을 원칙으로 합니다. 단, 사이트는 시스템 정기점검, 증설 및 교체를 위해 사이트가 정한 날이나 시간에 서비스를 일시중단 할 수 있으며 예정된 작업으로 인한 서비스 일시 중단은 사이트의 홈페이지에 사전에 공지하오니 수시로 참고하시길 바랍니다.</p>
        <p className="mb-1">② 단, 사이트는 다음 경우에 대하여 사전 공지나 예고 없이 서비스를 일시적 혹은 영구적으로 중단할 수 있습니다.</p>
        ...
        <p className="mt-1">③ 전항에 의한 서비스 중단의 경우 사이트는 사전에 공지사항 등을 통하여 회원에게 통지합니다. 단, 사이트가 통제할 수 없는 사유로 발생한 서비스의 중단에 대하여 사전공지가 불가능한 경우에는 사후공지로 대신합니다.</p>
      </section>

      <section>
        <h3 className="font-semibold text-base mb-2">제10조 서비스 이용 해지</h3>
        <p className="mb-1">① 회원이 사이트와의 이용계약을 해지하고자 하는 경우에는 회원 본인이 온라인을 통하여 등록해지 신청을 하여야 합니다. 한편, 사이트 이용 해지와 별개로 사이트에 대한 이용계약 해지는 별도로 하셔야 합니다.</p>
        <p>② 해지 신청과 동시에 사이트가 제공하는 사이트 관련 프로그램이 회원 관리 화면에서 자동적으로 삭제됨으로 운영자는 더 이상 해지신청자의 정보를 볼 수 없습니다.</p>
      </section>

      <section>
        <h3 className="font-semibold text-base mb-2">제11조 서비스 이용 제한</h3>
        <p className="mb-1">회원은 다음 각호에 해당하는 행위를 하여서는 아니 되며 해당 행위를 한 경우에 사이트는 회원의 서비스 이용 제한 및 적법한 조치를 할 수 있으며 이용계약을 해지하거나 기간을 정하여 서비스를 중지할 수 있습니다.</p>
        <div className="ml-4 space-y-1 text-sm">
      ...
      <section>
        <h3 className="font-semibold text-base mb-2">제12조 게시물의 관리</h3>
        <p className="mb-1">① 사이트의 게시물과 자료의 관리 및 운영의 책임은 운영자에게 있습니다. 운영자는 항상 불량 게시물 및 자료에 대하여 모니터링을 하여야 하며, 불량 게시물 및 자료를 발견하거나 신고를 받으면 해당 게시물 및 자료를 삭제하고 이를 등록한 회원에게 주의를 주어야 합니다.</p>
        <p className="mb-1">한편, 이용회원이 올린 게시물에 대해서는 게시자 본인에게 책임이 있으니 회원 스스로 본 이용약관에서 위배되는 게시물은 게재해서는 안 됩니다.</p>
        <p className="mb-1">② 정보통신윤리위원회 등 공공기관의 시정요구가 있는 경우 운영자는 회원의 사전동의 없이 게시물을 삭제하거나 이동 할 수 있습니다.</p>
        <p className="mb-1">③ 불량게시물의 판단기준은 다음과 같습니다.</p>
        <div className="ml-4 space-y-1 text-sm">
        ...
        <p className="mt-1">④ 사이트 및 운영자는 게시물 등에 대하여 제3자로부터 명예훼손, 지적재산권 등의 권리 침해를 이유로 게시중단 요청을 받은 경우 이를 임시로 게시 중단(전송중단)할 수 있으며, 게시중단 요청자와 게시물 등록자 간에 소송, 합의 기타 이에 준하는 관련 기관의 결정 등이 이루어져 사이트에 접수된 경우 이에 따릅니다.</p>
      </section>

      <section>
        <h3 className="font-semibold text-base mb-2">제13조 게시물의 보관</h3>
        <p>사이트 운영자가 불가피한 사정으로 본 사이트를 중단하게 될 경우, 회원에게 사전 공지를 하고 게시물의 이전이 쉽도록 모든 조치를 하기 위해 노력합니다.</p>
      </section>

      <section>
        <h3 className="font-semibold text-base mb-2">제14조 게시물에 대한 저작권</h3>
        <p className="mb-1">① 회원이 사이트 내에 게시한 게시물의 저작권은 게시한 회원에게 귀속됩니다. 또한 사이트는 게시자의 동의 없이 게시물을 상업적으로 이용할 수 없습니다. 다만 비영리 목적인 경우는 그러하지 아니하며, 또한 서비스 내의 게재권을 갖습니다.</p>
        <p className="mb-1">② 회원은 서비스를 이용하여 취득한 정보를 임의 가공, 판매하는 행위 등 서비스에 게재된 자료를 상업적으로 사용할 수 없습니다.</p>
        <p>③ 운영자는 회원이 게시하거나 등록하는 사이트 내의 내용물, 게시 내용에 대해 제12조 각호에 해당한다고 판단되는 경우 사전통지 없이 삭제하거나 이동 또는 등록 거부할 수 있습니다.</p>
      </section>

      <section>
        <h3 className="font-semibold text-base mb-2">제15조 손해배상</h3>
        <p className="mb-1">① 본 사이트의 발생한 모든 민, 형법상 책임은 회원 본인에게 1차적으로 있습니다.</p>
        <p>② 본 사이트로부터 회원이 받은 손해가 천재지변 등 불가항력적이거나 회원의 고의 또는 과실로 인하여 발생한 때에는 손해배상을 하지 않습니다.</p>
      </section>

      <section>
        <h3 className="font-semibold text-base mb-2">제16조 면책</h3>
        <div className="space-y-1">
          <p>① 운영자는 회원이 사이트의 서비스 제공으로부터 기대되는 이익을 얻지 못하였거나 서비스 자료에 대한 취사선택 또는 이용으로 발생하는 손해 등에 대해서는 책임이 면제됩니다.</p>
          <p>② 운영자는 본 사이트의 서비스 기반 및 타 통신업자가 제공하는 전기통신 서비스의 장애로 인한 경우에는 책임이 면제되며 본 사이트의 서비스 기반과 관련되어 발생한 손해에 대해서는 사이트의 이용약관에 준합니다</p>
          <p>③ 운영자는 회원이 저장, 게시 또는 전송한 자료와 관련하여 일체의 책임을 지지 않습니다.</p>
          <p>④ 운영자는 회원의 귀책 사유로 인하여 서비스 이용의 장애가 발생한 경우에는 책임지지 아니합니다.</p>
          <p>⑤ 운영자는 회원 상호 간 또는 회원과 제3자 상호 간, 기타 회원의 본 서비스 내외를 불문한 일체의 활동(데이터 전송, 기타 커뮤니티 활동 포함)에 대하여 책임을 지지 않습니다.</p>
          <p>⑥ 운영자는 회원이 게시 또는 전송한 자료 및 본 사이트로 회원이 제공받을 수 있는 모든 자료들의 진위, 신뢰도, 정확성 등 그 내용에 대해서는 책임지지 아니합니다.</p>
          <p>⑦ 운영자는 회원 상호 간 또는 회원과 제3자 상호 간에 서비스를 매개로 하여 물품거래 등을 한 경우에 그로부터 발생하는 일체의 손해에 대하여 책임지지 아니합니다.</p>
          <p>⑧ 운영자는 운영자의 귀책 사유 없이 회원간 또는 회원과 제3자간에 발생한 일체의 분쟁에 대하여 책임지지 아니합니다.</p>
          <p>⑨ 운영자는 서버 등 설비의 관리, 점검, 보수, 교체 과정 또는 소프트웨어의 운용 과정에서 고의 또는 고의에 준하는 중대한 과실 없이 발생할 수 있는 시스템의 장애, 제3자의 공격으로 인한 시스템의 장애, 국내외의 저명한 연구기관이나 보안 관련 업체에 의해 대응 방법이 개발되지 아니한 컴퓨터 바이러스 등의 유포나 기타 운영자가 통제할 수 없는 불가항력적 사유로 인한 회원의 손해에 대하여 책임지지 않습니다.</p>
        </div>
      </section>

      <section>
        <h3 className="font-semibold text-base mb-2">부칙</h3>
...
function PrivacyContent() {
  return (
    <>
      ...
      <section>
        ...
        <div className="ml-4 space-y-2">
          <div>
            ...
            <p className="ml-4 mt-1">다만, 다음의 사유에 해당하는 경우에는 해당 사유 종료 시까지</p>
          ...
          <div>
            <p className="font-medium">재화 또는 서비스 제공 : 재화․서비스 공급완료 및 요금결제․정산 완료 시까지</p>
            <p className="ml-4 mt-1">다만, 다음의 사유에 해당하는 경우에는 해당 기간 종료 시까지</p>
            <div className="ml-4 mt-1 text-sm">
              <p className="font-medium">「전자상거래 등에서의 소비자 보호에 관한 법률」에 따른 표시․광고, 계약내용 및 이행 등 거래에 관한 기록</p>
              <p className="ml-4">- 표시․광고에 관한 기록 : 6월</p>
              <p className="ml-4">- 계약 또는 청약 철회, 대금결제, 재화 등의 공급기록 : 5년</p>
              <p className="ml-4">- 소비자 불만 또는 분쟁 처리에 관한 기록 : 3년</p>
            </div>
            <div className="ml-4 mt-1 text-sm">
              <p className="font-medium">「통신비밀보호법」 제41조에 따른 통신사실확인자료 보관</p>
              <p className="ml-4">- 가입자 전기통신일시, 개시․종료 시간, 상대방 가입자 번호, 사용도수, 발신기지국 위치추적자료 : 1년</p>
              <p className="ml-4">- 컴퓨터 통신, 인터넷 로그 기록자료, 접속지 추적자료 : 3개월</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        <h3 className="font-semibold text-base mb-2">제3조 (개인정보의 제3자 제공)</h3>
        <p className="mb-2">① 회사는 정보주체의 개인정보를 제1조(개인정보의 처리목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.</p>
        <p className="mb-1">② 회사는 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.</p>
        <div className="ml-4 space-y-1 text-sm">
      ...
      <section>
        <h3 className="font-semibold text-base mb-2">제4조 (개인정보처리의 위탁)</h3>
        <p className="mb-2">① 회사는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.</p>
        <div className="ml-4 mb-2">
          <p className="font-medium">고객 센터 운영</p>
          <p className="ml-4 text-sm">- 위탁받는 자 (수탁자) : 고객센터</p>
          <p className="ml-4 text-sm">- 위탁하는 업무의 내용 : 응대 및 이용안내 등</p>
        </div>
      ...
      <section>
        <h3 className="font-semibold text-base mb-2">제5조 (이용자 및 법정대리인의 권리와 그 행사 방법)</h3>
        <p className="mb-1">① 정보주체는 회사에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.</p>
        <div className="ml-4 space-y-1 mb-2 text-sm">
          <p>1. 개인정보 열람요구</p>
      ...
      <section>
        <h3 className="font-semibold text-base mb-2">제6조 (처리하는 개인정보 항목)</h3>
        <p className="mb-2">회사는 다음의 개인정보 항목을 처리하고 있습니다.</p>
        <div className="space-y-2 ml-4 text-sm">
          <div>
            <p className="font-medium">1. 홈페이지 회원 가입 및 관리</p>
            <p className="ml-4">- 필수항목 : 예) 성명, 아이디, 비밀번호, 업체명, 사업자 번호, 이메일 주소, 연락처, 담당자명</p>
            <p className="ml-4">- 선택항목: 없음</p>
          </div>
          <div>
            <p className="font-medium">2. 재화 또는 서비스 제공</p>
            <p className="ml-4">- 필수항목 : 예) 성명, 생년월일, 아이디, 비밀번호, 업체명, 사업자 번호, 이메일 주소, 연락처, 아이핀번호, 신용카드번호, 은행계좌정보 등 결제정보</p>
            <p className="ml-4">- 선택항목 : 관심분야, 과거 구매내역</p>
          </div>
          <div>
            <p className="font-medium">3. 인터넷 서비스 이용과정에서 아래 개인정보 항목이 자동으로 생성되어 수집될 수 있습니다.</p>
      ...
      <section>
        <h3 className="font-semibold text-base mb-2">제7조 (개인정보의 파기)</h3>
        ...
        <p className="mb-1">③ 개인정보 파기의 절차 및 방법은 다음과 같습니다.</p>
        <div className="ml-4 space-y-2">
          <div>
            <p className="font-medium">1. 파기 절차</p>
            <p className="ml-4 text-sm">회사는 파기 사유가 발생한 개인정보를 선정하고, 회사의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.</p>
          </div>
          <div>
            <p className="font-medium">2. 파기 방법</p>
            <p className="ml-4 text-sm">회사는 전자적 파일 형태로 기록․저장된 개인정보는 기록을 재생할 수 없도록 로우레밸포멧(Low Level Format) 등의 방법을 이용하여 파기하며, 종이 문서에 기록․저장된 개인정보는 분쇄기로 분쇄하거나 소각하여 파기합니다.</p>
          </div>
        </div>
      </section>

      <section>
        <h3 className="font-semibold text-base mb-2">제8조 (개인정보의 안전성 확보조치)</h3>
        <p className="mb-1">회사는 개인정보의 안전성 확보를 위해 다음과 같은 조치를 하고 있습니다.</p>
        <div className="ml-4 space-y-1 text-sm">
      ...
      <section>
        <h3 className="font-semibold text-base mb-2">제9조 (개인정보 자동 수집 장치의 설치∙운영 및 거부에 관한 사항)</h3>
        <p className="mb-2">① 회사는 이용자에게 개별적인 맞춤 서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 '쿠키(cookie)'를 사용합니다.</p>
        <p className="mb-1">② 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)가 이용자의 컴퓨터 브라우저에 보내는 소량의 정보이며 이용자들의 컴퓨터 내의 하드디스크에 저장되기도 합니다.</p>
        <div className="ml-4 space-y-1 text-sm">
      ...
      <section>
        <h3 className="font-semibold text-base mb-2">제10조 (개인정보 보호책임자)</h3>
        <p className="mb-2">① 회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만 처리 및 피해구제 등을 위하여 개인정보 보호책임을 담당하고 있습니다.</p>
      ...
      <section>
        <h3 className="font-semibold text-base mb-2">제11조 (개인정보 열람청구)</h3>
        <p>정보주체는 개인정보 보호법 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다. 회사는 정보주체의 개인정보 열람 청구가 신속하게 처리되도록 노력하겠습니다.</p>
      </section>

      <section>
        <h3 className="font-semibold text-base mb-2">제12조 (권익침해 구제 방법)</h3>
        <p className="mb-2">정보주체는 아래의 기관에 대해 개인정보 침해에 대한 피해구제, 상담 등을 문의하실 수 있습니다.</p>
        <div className="space-y-3 ml-4 text-sm">
          <div>
            <p className="font-medium">▶ 개인정보 침해신고센터 (한국인터넷진흥원 운영)</p>
            <p className="ml-4">- 소관 업무 : 개인정보 침해사실 신고, 상담 신청</p>
            <p className="ml-4">- 홈페이지 : privacy.kisa.or.kr</p>
            <p className="ml-4">- 전화 : (국번없이) 118</p>
            <p className="ml-4">- 주소 : (58324) 전남 나주시 진흥길 9(빛가람동 301-2) 3층 개인정보침해신고센터</p>
          </div>
          <div>
            ...
            <p className="ml-4">- 주소 : (03171)서울특별시 종로구 세종대로 209 정부서울청사 4층</p>
          </div>
          <div>
            <p className="ml-4">▶ 대검찰청 사이버범죄수사단 : 02-3480-3573 (대검찰청)</p>
            <p className="ml-4">▶ 경찰청 사이버안전국 : 182 (http://cyberbureau.police.go.kr)</p>
          </div>
        </div>
      </section>

      <section>
        <h3 className="font-semibold text-base mb-2">제13조 (개인정보 처리방침 시행 및 변경)</h3>
        <p>이 개인정보 처리방침은 2025. 12. 07부터 적용됩니다.</p>
      </section>
    </>
  );
}
