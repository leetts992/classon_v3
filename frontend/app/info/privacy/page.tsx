      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-3">② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.</p>
            <div className="space-y-3 ml-4">
              <div>
                <p className="font-semibold">홈페이지 회원 가입 및 관리 : 사업자/단체 홈페이지 탈퇴 시까지</p>
                <p className="ml-4 mt-2">다만, 다음의 사유에 해당하는 경우에는 해당 사유 종료 시까지</p>
              ...
              <div>
                <p className="font-semibold">재화 또는 서비스 제공 : 재화․서비스 공급완료 및 요금결제․정산 완료 시까지</p>
                <p className="ml-4 mt-2">다만, 다음의 사유에 해당하는 경우에는 해당 기간 종료 시까지</p>
                <div className="ml-4 mt-2">
                  <p className="font-semibold">「전자상거래 등에서의 소비자 보호에 관한 법률」에 따른 표시․광고, 계약내용 및 이행 등 거래에 관한 기록</p>
                ...
                <div className="ml-4 mt-2">
                  <p className="font-semibold">「통신비밀보호법」 제41조에 따른 통신사실확인자료 보관</p>
          ...
          <section>
            ...
            <div className="ml-4 mb-4">
              <p className="font-semibold">고객 센터 운영</p>
              <p className="ml-4">- 위탁받는 자 (수탁자) : 고객센터</p>
              <p className="ml-4">- 위탁하는 업무의 내용 : 응대 및 이용안내 등</p>
            </div>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-4">제5조 (이용자 및 법정대리인의 권리와 그 행사 방법)</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-4">제6조 (처리하는 개인정보 항목)</h2>
            ...
            <div className="space-y-3 ml-4">
              ...
              <div>
                <p className="font-semibold">3. 인터넷 서비스 이용과정에서 아래 개인정보 항목이 자동으로 생성되어 수집될 수 있습니다.</p>
          ...
          <section>
            ...
            <div className="ml-4 space-y-3">
              ...
              <div>
                ...
                <p className="ml-4">회사는 전자적 파일 형태로 기록․저장된 개인정보는 기록을 재생할 수 없도록 로우레밸포멧(Low Level Format) 등의 방법을 이용하여 파기하며, 종이 문서에 기록․저장된 개인정보는 분쇄기로 분쇄하거나 소각하여 파기합니다.</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              ① 회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만 처리 및 피해구제 등을 위하여 개인정보 보호책임을 담당하고 있습니다.
            </p>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-4">제11조 (개인정보 열람청구)</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-4">제12조 (권익침해 구제 방법)</h2>
            <p className="mb-3">정보주체는 아래의 기관에 대해 개인정보 침해에 대한 피해구제, 상담 등을 문의하실 수 있습니다.</p>
            <div className="space-y-4 ml-4">
              <div>
                <p className="font-semibold">▶ 개인정보 침해신고센터 (한국인터넷진흥원 운영)</p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-4">제13조 (개인정보 처리방침 시행 및 변경)</h2>
            <p>이 개인정보 처리방침은 2025. 12. 07부터 적용됩니다.</p>
          </section>

          <div className="mt-12 pt-8 border-t border-gray-200 text-center">
            <p className="text-lg font-semibold text-gray-900">클래스온 | 개인정보처리방침</p>
          </div>
        </div>
      </div>
    </div>
